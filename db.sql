...
REPLACE INTO `arsipnew` (`id`, `code_archive`, `fk_gudang`, `fk_lajur`, `fk_box`, `fk_skpd`, `file`, `kode_klasifikasi`, `hasil_pelaksanaan`, `nomor_definitif`, `isi_berkas`, `unit_pengolah`, `bln_thn`, `month`, `years`, `bentuk_redaksi`, `media`, `kelengkapan`, `masalah`, `uraian_masalah`, `kode_mslh`, `r_aktif`, `r_inaktif`, `j_retensi`, `thn_retensi`, `nilai_guna`, `tingkat_perkembangan`, `pelaksana_hasil`, `status`, `create_at`, `edit_at`, `by_user`, `user_id`, `hasil`, `approval`) VALUES
	(1, 'GA/1A/BA.1/1', 1, 1, 1, 5, 'index (3).php', '001', '', 0, '', 'aspek', '0000-00-00', '6', '2007', 'Surat', 'T', '14238456930_report.pdf,14238456931_laporan.html', 'HARI BESAR KEAGAMAAN', 'MAHRABI UMAY', '003', 1, 2, 3, '2010', '1', 'Tembusan', '', '1', '2015-02-13 23:41:33', '2015-02-13 23:41:33', 'user1', 4, '1', '');
...
CREATE TABLE IF NOT EXISTS `lembaga` (
  ...
  `by_user` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='table untuk master skpd/perusahaan ataupun lembaga ';

-- Dumping data for table e_arsip.lembaga: ~13 rows (approximately)
...
-- Dumping data for table e_arsip.user: ~4 rows (approximately)
