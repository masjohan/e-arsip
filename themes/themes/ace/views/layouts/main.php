				...
				<ul class="nav nav-list">
					...
					<li <?php if(Yii::app()->controller->id == 'archive') echo 'class="active"' ;?>>
						...
						<ul class="submenu">
							...
							<li <?php if(Yii::app()->controller->action->id == 'retensi') echo 'class="active"' ;?>>
								<a href="<?php echo Yii::app()->request->baseUrl ?>/archive/retensi">
									<i class="icon-double-angle-right"></i>
									View Retensi Archive
								</a>
							</li>
			...
			<ul class="nav nav-list">
					...
					<li <?php if(Yii::app()->controller->id == 'archive') echo 'class="active"' ;?>>
						...
						<ul class="submenu">
							...
							<li <?php if(Yii::app()->controller->action->id == 'archive') echo 'class="active"' ;?>>
								<a href="<?php echo Yii::app()->request->baseUrl ?>/archive">
									<i class="icon-double-angle-right"></i>
									Active Archive
								</a>
